...
<div class="container py-5">
    <cftry>
        ...
        <cfif structKeyExists(url, "code")>
            ...
            <cfif structKeyExists(variables.response, "access_token")>
                <cfset variables.AccessToken = variables.response.access_token />

                <cfset Session.Token = Variables.response />

                <div class="alert alert-success">
                    <strong>Success:</strong> Access token has been stored in session successfully.
                </div>
            <cfelse>
                <div class="alert alert-danger">
                    <strong>Error:</strong> No access token received. Please check your OAuth configuration.
                </div>
            </cfif>
        <cfelse>
            <!--- Exchange the code for an access token --->
        ...
        <cfif structKeyExists(session, "token")>
            <div class="card shadow mb-4">
                <div class="card-header bg-success text-white p-3">
                    Send Email
                </div>
                <div class="card-body">
                    <form method="post" action="./examples/email.cfm">
                        <div class="mb-3">
